                ...
                <table class="list">
                    ...
                    foreach ($processingOrderList as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= ($value['status'] != "Processing") ? $value['receivedDate'] : "Xử lý đơn hàng mới" ?> <?=  ($value['status'] != "Complete" && $value['status'] != "Processing") ? "(Dự kiến)" : "" ?> </td>
                            <td><?= $value['status'] ?></td>
                            <td>
                ...
                <table class="list">
                    ...
                    foreach ($processedOrderList as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value['id'] ?></td>
                            <td><?= $value['createdDate'] ?></td>
                            <td><?= ($value['status'] != "Processing") ? $value['receivedDate'] : "Đơn hàng đang được xử lý" ?> <?=  ($value['status'] != "Complete" && $value['status'] != "Processing") ? "(Dự kiến)" : "" ?> </td>
                            <td><?= $value['status'] ?></td>
                            <td>
                ...
                <table class="list">
                    ...
                    foreach ($deliveringOrderList as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value['id'] ?></td>
                            <td><?= $value['createdDate'] ?></td>
                            <td><?= ($value['status'] != "Processing") ? $value['receivedDate'] : "Vui lòng thanh toán khi nhận hàng sau khi đơn hàng đã được xử lý" ?> <?=  ($value['status'] != "Complete" && $value['status'] != "Processing") ? "(Dự kiến)" : "" ?> </td>
                            <td><?= $value['status'] ?></td>
                            <td>
                                <a href="orderlistdetail.php?orderId=<?= $value['id'] ?>">Chi tiết</a>
                            </td>
